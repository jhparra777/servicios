...
Route::group(['prefix' => 'cv'], function () {
    ...
    */
    ...
    Route::group(['middleware' => ['valida_cv', "sesion_datos_basicos", "valida_datos_basicos"]], function () {
        ...
        Route::post("tiene_vencimiento", ["as" => "tiene_vencimiento", "uses" => "DocumentosController@tiene_vencimiento"]);
...
Route::group(['prefix' => 'admin'], function () {
    ...
    */
    ...
    Route::group(['middleware' => ['valida_admin','sesion_admin']], function () {
        ...
        Route::get("admin.gestion_documental.download_carpetas_GDC/{cliente_id}", ["as" => "admin.gestion_documental.download_carpetas_GDC", "uses" => "GestionDocumentalController@downloadCarpetasGDC"]);

        Route::get("admin.gestion_documental.download_categoria_carpeta_GDC/{cliente_id}/{categoria_id}", ["as" => "admin.gestion_documental.download_categoria_carpeta_GDC", "uses" => "GestionDocumentalController@download_categoria_carpeta_GDC"]);
    ...
    Route::get('aceptacion-de-politica-tratamiento-de-datos/{user_id?}', [
    ...
    Route::group(['middleware' => ['valida_admin', 'sesion_admin']], function () {
        ...
        //reporte ministerio trabajo
        Route::get("reportes/ministerio", [
            'as'    =>  'admin.reporte_ministerio_trabajo',
            'uses'  =>  'ReporteMinisterioController@index'
        ]);

        Route::get("reportes/ministerio/excel", [
            'as'   => 'admin.reporte_ministerio_trabajo_excel',
            'uses' => 'ReporteMinisterioController@excel',
        ]);
        ...
        //Reporte Contratados y Hoja de vida
        Route::get("reporte-contratado-hoja-vida", [
            'as'   => 'admin.reporte_contratado_hoja_vida',
            'uses' => 'ReporteContratadoHojaVidaController@contratado_hoja_vida',
        ]);

        //Reporte Contratados y Hoja de vida Excel
        Route::get("reporte-contratado-hoja-vida-excel", [
            'as'   => 'admin.reporte_contratado_hoja_vida_excel',
            'uses' => 'ReporteContratadoHojaVidaController@contratado_hoja_vida_excel',
        ]);
