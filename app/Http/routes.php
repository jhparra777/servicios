...
Route::get("generar_carnet/{id}", ["as" => "generar_carnet_general", "uses" => "ReclutamientoController@generar_carnet_general"]);
    ...
    */
    ...
    Route::group(['middleware' => ['valida_admin', 'sesion_admin']], function () {
        ...
        */
        ...
        Route::get("creditos-funcionalidades", ["as" => "admin.lista_creditos_funcionalidades", "uses" => "CreditosFuncionalidadesController@index"]);
