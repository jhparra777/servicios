    ...
    public function rules()
    {
        ...
        elseif(route("home") == "https://vym.t3rsc.co" || route("home") == "https://listos.t3rsc.co"){
            ...
            return [
                ...
                "tipo_vehiculo"        => "required_if:tiene_vehiculo,1",
                "numero_licencia"      => "required_if:tiene_licencia,1",
    ...
    public function messages()
    {
        if (route("home") == "http://komatsu.t3rsc.co" || route("home") == "https://komatsu.t3rsc.co") {
            ...
            return [
                ...
                "peso_id.required" => "Debe seleccionar un peso",
                "estatura_id.required" => "Debe seleccionar una estatura",
                "estrato.required" => "Debe seleccionar un estrato" 
            ];
        }
    }
}
