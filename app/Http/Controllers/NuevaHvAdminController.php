...
class NuevaHvAdminController extends Controller
{
    ...
    */
    ...
    public function datos_hv(Request $data, $user_id)
    {
        ...
        $estrato = [""=>"Seleccionar"] + DB::table("estrato")->where("active", 1)->pluck("descripcion","id")->toArray();

        $pesos = [""=>"Seleccionar"] + DB::table("peso")->where("active", 1)->pluck("descripcion","id")->toArray();

        $estaturas = [""=>"Seleccionar"] + DB::table("estatura")->where("active", 1)->pluck("descripcion","id")->toArray();

        $tipos_vivienda = [""=>"Seleccionar"] + DB::table("tipos_vivienda")->where("active", 1)->pluck("descripcion","id")->toArray();
        ...
        $talla_zapatos = [""=>"Seleccionar"] + DB::table("talla_zapatos")->where("active", 1)->pluck("descripcion","id")->toArray();

        $talla_camisa = [""=>"Seleccionar"] + DB::table("talla_camisa")->where("active", 1)->pluck("descripcion","id")->toArray();

        $talla_pantalon = [""=>"Seleccionar"] + DB::table("talla_pantalon")->where("active", 1)->pluck("descripcion","id")->toArray();

        $profesiones_sorttime = [""=>"Seleccionar"] + DB::table("profesiones_sorttime")->where("active", 1)->pluck("descripcion","id")->toArray();

        $cabeza_familia = [""=>"Seleccionar"] + DB::table("cabeza_familia")->where("active", 1)->pluck("descripcion","id")->toArray();

        $grupos_poblacionales = [""=>"Seleccionar"] + DB::table("grupos_poblacionales")->where("active", 1)->pluck("descripcion","id")->toArray();
        ...
        $nivelEstudios = ["" => "Seleccionar"] + NivelEstudios::where('active', 1)->orderBy('jerarquia')->pluck("descripcion", "id")->toArray();
    ...
    public function ver_documentos($user_id,Request $data)
    {
        ...
        return view("admin.hv.documentos.documentos", compact("tipoDocumento", "documentos", "documentosFamiliares", "tipoDocumentoFamiliar", "gruposFamiliares", "usuario", "archivos","tipos_afiliacion"));
    }
