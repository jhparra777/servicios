...
class CargosEspecificosController extends Controller
{
    ...
    public function editar(Request $request)
    {
        ...
        //codigos ciiu
        $codigos_ciiu = ["" => "Seleccionar"] + CodigoCIIU::where("active", 1)->orderBy("nombre")->pluck("nombre", "id")->toArray();
        $codigos_cno = ["" => "Seleccionar"] + CodigoCNO::where("active", 1)->pluck("descripcion", "id")->toArray();
