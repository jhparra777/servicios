...
use App\Models\RangoTamanioCliente;
...
class ClientesController extends Controller
{
    ...
    public function crear_cliente(Request $data)
    {
        ...
        $tamanio_empresa = ["" => "Seleccionar"] + RangoTamanioCliente::pluck("descripcion", "id")->toArray();

  
        $roles = Sentinel::getRoleRepository()->whereNotIn("slug", ["req", "admin", "hv","God"])->pluck("name", "id")->toArray();

        return view("admin.clientes.nuevo_cliente", compact("permisos","usuarios", "roles","tamanio_empresa"));
    ...
    public function editar_cliente_admin($id, Request $data)
    {
        ...
        return view("admin.clientes.editar_cliente", compact("cliente", "txtUbicacion", "tamanio_empresa"));
    }
