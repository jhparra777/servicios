...
{   
    ...
    public function cargarDocumentoGrupoFamiliar(Request $request){
        ...
        $documentos = DocumentoFamiliar::leftjoin("tipo_afiliacion", "tipo_afiliacion.id", "=", "documentos_familiares.tipo_afiliacion_id")
        ...
        ->where('documentos_familiares.grupo_familiar_id', $request->grupo_familiar_id)
        ->get();

        $grupo_familiar_id = $request->grupo_familiar_id;

        return view("cv.modal.cargar_documento_grupo_familiar", compact("tiposDocumentos", "documentos", "grupo_familiar_id","tipos_afiliacion"));
    }
