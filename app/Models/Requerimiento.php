...
class Requerimiento extends Model
{
    ...
    {
        return $this->hasOne("App\Models\Nivel5", "id", "nivel_5_id")->first();
    }

    public function nivel6()
    {
        return $this->hasOne("App\Models\Nivel6", "id", "nivel_6_id")->first();
    }

    public function nivel7()
    {
        return $this->hasOne("App\Models\Nivel7", "id", "nivel_7_id")->first();
    }

    public function nivel8()
    {
        return $this->hasOne("App\Models\Nivel8", "id", "nivel_8_id")->first();
    }
