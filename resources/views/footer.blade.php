            ...
            <div class="row">
                ...
                @if(route("home")!="https://expertos.t3rsc.co" && route("home")!="https://gpc.t3rsc.co")
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        ...
                        <ul class="use-slt-link">
                            <li>
                                <a target="_blank" href="{{ route('admin.aceptacionPoliticaTratamientoDatos') }}">Tratamiento de datos personales Proservis</a>
                            </li>
                            <li id="inactivaBotonesModal">
                                <a href="#" data-toggle="modal" data-target="#myModal">Tratamiento de datos personales</a>
                            </li>
