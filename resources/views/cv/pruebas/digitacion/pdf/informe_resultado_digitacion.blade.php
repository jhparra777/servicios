	...
	<main>
		...
		<section>
			<div class="text-justify">
				<p>
					Bienvenido, en PROSERVIS hemos preparado un informe personalizado referente a la prueba de digitación realizada a {{ $candidato_digitacion->nombres }}, quien es uno de los participantes en el proceso.
				</p>
			</div>
		</section>
