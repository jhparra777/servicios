	...
	<main class="main">		
		...
		<section>
			<div class="text-justify color-sec">
				<p>
					Bienvenido, en PROSERVIS hemos preparado un informe personalizado referente a la evaluación psicotécnica realizada a {{ $candidato_prueba->nombres }}, quien es uno de los participantes en el proceso de selección.
				</p>
