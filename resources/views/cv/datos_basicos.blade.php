...
@section('content')
                        ...
                        <div class="form-alt">
                            ...
                            <div class="row">
                                ...
                                @if(route('home') != "http://komatsu.t3rsc.co" && route('home') != "https://komatsu.t3rsc.co")
                                    ...
                                    @if(route('home') != "http://colpatria.t3rsc.co" && route('home') != "https://colpatria.t3rsc.co" &&
                                        ...
                                        @if(route('home') != "https://gpc.t3rsc.co")
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                {!! Form::select("rh",[""=>"Seleccionar","positivo"=>"Positivo","negativo"=>"Negativo"],null,["class"=>"form-control selectcategory", "id"=>"rh"]) !!}
                                    ...
                                    <div id="mujer_cabeza_familia" class="col-md-6 col-sm-12 col-xs-12" style="display:none;">
                                        <label> ¿Es mujer cabeza de familia? <span></span>
                                        </label>

                                        {!! Form::select("cabeza_familia_id", $cabeza_familia,null,["class"=>"form-control selectcategory","id"=>"cabeza_familia"]) !!}
                                        
                                        <p class="error text-danger direction-botones-center">
                                            {!! FuncionesGlobales::getErrorData("cabeza_familia",$errors) !!} </p>
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <label> Talla zapatos <span>*</span>
                                    </label>
                                    {!! Form::select("talla_zapatos",$talla_zapatos,$datos_basicos->talla_zapatos,["class"=>"form-control", "id"=>"talla_zapatos"]) !!}
                                    <p class="error text-danger direction-botones-center">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <label>
                                        Talla camisa <span>*</span>
                                    </label>

                                    {!! Form::select("talla_camisa",$talla_camisa,$datos_basicos->talla_camisa,["class"=>"form-control", "id"=>"talla_camisa"]) !!}
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <label>
                                        Talla pantalón <span>*</span>
                                    </label>

                                    {!!Form::select("talla_pantalon",$talla_pantalon,$datos_basicos->talla_pantalon,["class"=>"form-control", "id"=>"talla_pantalon"])!!}
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    {!!Form::select("peso_id",$pesos,$datos_basicos->peso_id,["class"=>"form-control", "id"=>"peso_id"])!!}

                                    <p class="error text-danger direction-botones-center">
                                        {!!FuncionesGlobales::getErrorData("peso_id",$errors)!!}
                                    </p>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    {!!Form::select("estatura_id",$estaturas,$datos_basicos->estatura_id,["class"=>"form-control", "id"=>"estatura_id"])!!}

                                    <p class="error text-danger direction-botones-center">
                                        {!!FuncionesGlobales::getErrorData("estatura_id",$errors)!!}
                                    </p>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    {!! Form::select("tipo_vivienda_id",$tipos_vivienda,null,["class"=>"form-control selectcategory", "id"=>"tipo_vivienda_id"]) !!}

                                    <p class="error text-danger direction-botones-center">
                                        {!!FuncionesGlobales::getErrorData("tipo_vivienda_id", $errors)!!}
                                    </p>
                                </div>

                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <label> Estrato</label>
                                    {!! Form::select("estrato",$estrato,null,["class"=>"form-control selectcategory", "id"=>"estrato"]) !!}
                                ...
                                <div id="grupo_poblacional" class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    {!!Form::select("grupo_poblacional",$grupos_poblacionales, $datos_basicos->grupo_poblacional,["class"=>"form-control selectcategory", "id" => "select_grupo_poblacional"])!!}
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    {!!Form::select("profesion_sorttime_id",$profesiones_sorttime,$datos_basicos->profesion_id,["class"=>"form-control", "id"=>"profesiones_sorttime"])!!}

                                    <p class="error text-danger direction-botones-center">
                                        {!!FuncionesGlobales::getErrorData("profesion_sorttime_id",$errors)!!}
                                    </p>
                                </div>
                                  ...
                                  @if(route('home') != "http://komatsu.t3rsc.co" && route('home') != "https://komatsu.t3rsc.co" && route('home') != "https://gpc.t3rsc.co")
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                     <label>@if(route("home")=="https://humannet.t3rsc.co") Fondo de salud @else Entidad promotora de salud (EPS) @endif  @if(route('home') == "http://colpatria.t3rsc.co" || route('home') == "https://colpatria.t3rsc.co") / Health Promotion Entity  @endif <span></span> </label>
                                        {!! Form::select("entidad_eps",$entidadesEps,$datos_basicos->entidad_eps,["class"=>"form-control","id"=>"entidad_eps"]) !!}
                                        ...
                                        route('home') != "http://colpatria.t3rsc.co" || route('home') != "https://colpatria.t3rsc.co")
                                            ...
                                            <div id="situacion_militar">
                                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                    ...
                                                    {!!Form::select("situacion_militar_definida",[""=>"Seleccionar","1"=>"si","0"=>"no"],$datos_basicos->situacion_militar_definida,["class"=>"form-control militar_situacion"])!!}
    ...
    @if ( $datos_basicos->politicasPrivacidad()->count() == 0 )
        <script>
            const msgModalPolities = "Para continuar con el uso de nuestra plataforma, debes aceptar nuestras políticas de privacidad. <a type='button' data-toggle='modal' data-target='#modal_polities' href='#'>Ver políticas</a>"
        </script>
    @elseif( $datos_basicos->politicasPrivacidad()->count() < $cantidad_politicas )
        <script>
            const msgModalPolities = "Hemos actualizado nuestra política de privacidad, para continuar con el uso de nuestra plataforma por favor haz clic en aceptar. <a type='button' data-toggle='modal' data-target='#modal_polities' href='#'>Ver políticas</a>"
        </script>
    @else
        <script>
            const msgModalPolities = "Para continuar con el uso de nuestra plataforma, debes aceptar nuestras políticas de privacidad. <a type='button' data-toggle='modal' data-target='#modal_polities' href='#'>Ver políticas</a>"
    ...
    @if ( !$datos_basicos->aceptoPoliticaActual() )
        <script>
        ...
        $(function () {
           ...
           @endif
            ...
            function genero(){
                ...
                $("#mujer_cabeza_familia").hide();

                if(valu == 2)
                    $("#mujer_cabeza_familia").show();
