                ...
                <div class="col-md-12">
                    <div class="my-account-form formulario-registro">
                        ...
                        {!! Form::open(['id'=>"fr_pre",'route' => 'process_registro',"autocomplete"=>"off", "files"=>true]) !!}
                            ...
                            -->
                            <div class="form-group">
                                <label for="acepto_politicas_privacidad_soluciones">
                                    Aceptar política de privacidad Proservis
                                </label>

                                {!! Form::checkbox('acepto_politicas_privacidad_proservis', 1, false, ['class' => 'checkbox-preferencias', 'id' => 'acepto_politicas_privacidad_proservis', 'required']) !!}
                                
                                <span style="color: red;">*</span>

                                <a target="_blank" href="{{ route('admin.aceptacionPoliticaTratamientoDatos') }}" class="btn btn-primary btn-xs" style="background: #00b053"> Ver política de protección de datos</a>

                            </div>

                            <div class="form-group">
                                <label for="acepto_politicas_privacidad">
                                    Aceptar política de privacidad
                                    @if(route("home") == "http://colpatria.t3rsc.co" || route("home") == "https://colpatria.t3rsc.co") /Privacy Politic @endif
                                </label>

                                {!! Form::checkbox('acepto_politicas_privacidad', 1, false, ['class' => 'checkbox-preferencias', 'id' => 'acepto_politicas_privacidad', 'required']) !!}

                                {!! Form::hidden('politicas_privacidad_id', $politica->id) !!}
                                
                                <span style="color: red;">*</span>

                                <button id="activaBotonesModal" type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal" style="background: #00b053"> Ver política de protección de datos</button>

                                <p class="text-danger">{!! FuncionesGlobales::getErrorData("acepto_politicas_privacidad", $errors) !!}</p>
                            </div>
