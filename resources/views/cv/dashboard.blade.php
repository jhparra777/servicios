...
@section('content')
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="dashboard_listing_blcok">
                    <div class="col-md-3 col-sm-6">
                        <div class="statusbox">
                            <h3  style="background-color: {{ $sitio->color }};color: white;">% DATOS BÁSICOS</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="statusbox">
                            <h3 style="background-color: {{ $sitio->color }};color: white;">% @if(route("home")=="https://humannet.t3rsc.co")CURRÍCULO  @else HOJA DE VIDA @endif </h3>
                            <div class="statusbox-content">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="statusbox">
                            <h3 style="background-color: {{ $sitio->color }};color: white;"><a href="{{route('mis_ofertas')}}#ofertas_aplicadas" style="color:white;">N° APLICACIONES</a></h3>
                            <div class="statusbox-content">
                    ...
                    @else
                        <div class="col-md-3 col-sm-6">
                            <div class="statusbox">
                                <h3 style="background-color: {{ $sitio->color }};color: white;"><a href="{{route('mis_ofertas')}}#ofertas_en_proceso" style="color:white;">PROCESOS ACTIVOS</a></h3>
                                <div class="statusbox-content">
                                    <p class="ic_status_item ic_col_four"><i class="fa fa-cogs"></i></p>
                                    <h2>{{ $procesos_activos }}</h2>
                                    <span>Procesos activos en los que estas participando</span>
                            ...
                            <div class="recent-listing-box-container-item list-view-item" style="background: white;">
                                <div class="col-md-4 col-sm-12 nopadding feature-item-listing-item listing-item" style="background: white; height: 100%;border: none;">
                                    <div class="">
                                        ...
                                        <img src="{{ url( (($sitio->logo != "") ? "configuracion_sitio/$sitio->logo" : "img/personaDefectoG.jpg") )}}" alt="img1" style="margin-top: 50px;">
                                    </div>
    ...
    @if ( !$datosBasicos->aceptoPoliticaActual() )
        <script>
