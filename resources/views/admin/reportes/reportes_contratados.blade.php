...
{{-- 
    ...
    <div class="col-md-6 form-group">
        <label class="col-sm-4 control-label" for="rango_fecha">Rango de fecha de firma de contrato:</label>
        <div class="col-sm-8">
...
<script>
    $(function () {
      ...
      $('#export_excel_btn').click(function(e){
          ...
          //$(this).prop("href","{{ route('admin.reportes_detalles_reportes_contratados_excel') }}?"+$data_form+"&formato=xlsx&rango_fecha="+$rango_fecha+"&cliente_id="+$cliente_id+"&usuario_envio="+$usuario_envio+"&req_id="+$req_id)
