...
@if ($visita->clase_visita_id == 1)
    ...
    <section class="center">
        ...
        {{-- Subtitulo vp_fraude --}}
        @if(!empty($visita->vp_fraude))
            <ul>
                <li>
                    <div class="ml-1">
                        <p class="color fw-700" style="font-size: 12pt;">¿Alguna vez le han propuesto hacer algún fraude  en la compañia? Sí</p>
                        <hr align="left" class="divider-25" style="margin-top: -.6rem;">
                    </div>
                    <ul>
                        <li>
        ...
        @if(!empty($visita->vp_llamado))
            <ul>
                <li>
                    <div class="ml-1">
                        <p class="color fw-700" style="font-size: 12pt;">¿Ha tenido algún llamado de atención en la empresa? Sí</p>
                        <hr align="left" class="divider-25" style="margin-top: -.6rem;">
                    </div>
                    <ul>
                        <li>
