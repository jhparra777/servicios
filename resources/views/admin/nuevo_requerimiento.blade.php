...
@section("contenedor")
                ...
                <div class="chart">
                    <div class="container" id="multiciudad_req">
                        <div class="row" style="border-bottom: solid 1px #bfbfbf; padding-top: 1.4rem;">
                            ...
                            <div class="col-md-3 form-group">
                                <div class="col-sm-12">
                                    <label>Asignado a: <span class="">*</span></label>
                                    {!! Form::select("asignado_a_multi[]",$psicologos, null, ["class"=>"form-control", "id" => "asignado_a_multi", "required" => "required"]); !!}
                                </div>
                            </div>
    ...
    <script>
        ...
        function crearCargo() {
            ...
            $.ajax({
                ...
                beforeSend: function(){
                    //imagen de carga
                    $.blockUI({
                        message: '<img src="{{url("configuracion_sitio/loading_proservis.gif")}}">', 
                        css: { 
                            border: "0",
        ...
        $(document).on('click', '#enviar_requerimiento_btn', function() {
            ...
            else if($('#asignado_a').val() == ''){
                $('#asignado_a').css('border', 'solid 1px red');
                $('#asignado_a').focus();

                setTimeout(function(){
                    $('#asignado_a').css('border', 'solid 1px #d2d6de');
                }, 4000);
            }
            else if($('#nivel_5').val() == ''){
