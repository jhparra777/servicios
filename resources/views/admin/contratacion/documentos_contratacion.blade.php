...
@section('contenedor')
	...
	@if ($firmaContrato != null)
		@if ($firmaContrato->estado == 1 || $firmaContrato->estado === 1)
			...
			@else
				@if( App\Jobs\FuncionesGlobales::validaBotonProcesosAsistente($req, $candidato_id, ["PRE_CONTRATAR"]) )
				<div class="row">
					<div class="col-md-12">
						<a type="button" class="btn btn-primary" href="{{route('generar_carnet_general',$candidato_id)}}" target="_blank"> Carnet Candidato </a>
					</div>
				</div>
				@endif
			@endif
