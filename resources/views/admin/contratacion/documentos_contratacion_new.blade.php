            ...
            <div class="btn-group">
                   <button 
                    ...
                    <ul class="dropdown-menu">
                        @if ( $firmaContrato->contrato !== null || $firmaContrato->contrato !== '' || App\Jobs\FuncionesGlobales::validaBotonProcesosAsistente($req, $candidato_id, ["PRE_CONTRATAR"]))
                        ...
                        @if($carta_presentacion != null)
				 			@if(file_exists("recursos_carta_presentacion/$carta_presentacion->nombre_archivo"))
					 			<a class="btn btn-default btn-block | text-left tri-bd--none tri-br-0 tri-txt-gray-600 tri-hover-bd--none" href='{{route("view_document_url", encrypt("recursos_carta_presentacion/"."|".$carta_presentacion->nombre_archivo))}}' target="_blank">
									Carta Presentación
								</a>
							@endif
				 		@endif
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pd-0">
                                                                <div class="btn-group-vertical" role="group" aria-label="..." style="width: 100%;">
                                                                    ...
                                                                    <button class="btn btn-default btn-sm btn-block | text-left tri-bd--none tri-br-0 tri-txt-gray-600 tri-hover-bd--none" style="margin-right: 6px; border: 0; text-transform: uppercase;" type="button" title="Eliminar archivo"  data-id="{{ $doc->id_documento }}" onclick="eliminarDocumento(this);">
