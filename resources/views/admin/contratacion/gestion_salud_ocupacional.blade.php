                    ...
                    <div class="chart">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        @if (str_contains($candidatos->documento, '['))
                                            <?php
                                                $archivos = (array)json_decode($candidatos->documento);
                                            ?>
                                            @foreach($archivos as $archivo)
                                                <li><a  href='{{route("view_document_url", encrypt("recursos_documentos_verificados/"."|".$archivo))}}' target="_blank">{{ $archivo }}</a></li>
                                            @endforeach
                                        @else
                                            <li><a  href='{{route("view_document_url", encrypt("recursos_documentos_verificados/"."|".$candidatos->documento))}}' target="_blank">{{ $candidatos->documento }}</a></li>
                                        @endif                    
                                    </ul>
