...
@section('contenedor')
    <div class="row">
        ...
        <div class="col-sm-12" style="text-align: left; margin-top: 15px;">
            <a style=" color:#FF0000;text-decoration:none;color:white;" type="button" class="btn btn-info" href="{{ route("admin.aceptacionPoliticaTratamientoDatos", ["user_id" => $candidato_id]) }}" target="_blank">
