...
@if($sitioModulo->evaluacion_sst == 'enabled' && $configuracion_sst->envia_evaluacion_asistente == 'si')
    <div class="col-md-1">
        <button 
            type="button" 
            class="btn btn_evaluacion_sst_masivo | tri-circle-btn tri-gray-100 tri-txt-gray-700 hover-bd-gray-400 tri-transition-300"
            data-toggle="tooltip"
            data-placement="top"
            data-container="body"
            title="{{ $configuracion_sst->titulo_boton_envio_proceso }}"
            >
