                                            ...
                                            @endif
                                               ...
                                               <!--         ESTATUS -->
                                                ...
                                                @if($user_sesion->hasAccess("boton_ws"))
                                                    <a target="_blank" href="https://api.whatsapp.com/send?phone={!! env('INDICATIVO','57') !!}{{ $candidato_req->telefono_movil}}&text=Hola!%20{{$candidato_req->nombres}} %20te%20hablamos%20del%20equipo%20de%20selección%20de%20{{$sitio->nombre}},%20revisamos%20tu%20hoja%20de%20vida%20y%20queremos%20que%20participes%20en%20nuestros%20procesos%20de%20selección.Te%20invitamos%20a%20que%20ingreses%20en%20el%20siguiente%20enlace%20y%20completes%20tus%20datos:%20https://proservis.t3rsc.co/%20debes%20estar%20atent@%20al%20correo%20electrónico%20%20para%20conocer%20los%20pasos%20adicionales%20en%20el%20proceso." class="btn  btn-sm  btn-success aplicar_oferta" @if($boton || isset($transferido)) disabled @endif>
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        ...
                                                        <li>
                                                            <button
                                                                type="button"
                                                                style="width: 100%"
                                                                {!! ((FuncionesGlobales::validaBotonProcesos($candidato_req->req_candidato_id, ["ENVIO_EXAMENES", "ENVIO_CONTRATACION"])) ? "" : "") !!}
