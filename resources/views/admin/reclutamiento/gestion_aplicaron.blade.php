@foreach($candidatos_cargo_general as $candidato)
    <tr id="tr_candidato_{{ $candidato->id_aplicaron }}">
        ...
        <td>
            @if ($candidato->fuente === 'trabaja_con_nosotros')
                <img src="https://qa-trabajaconnosotros.s3.amazonaws.com/tcn-src/only-octopus.png" width="24" title="Candidato aplicado desde trabajaconnosotros.co" alt="Trabaja con nosotros">
            @else
                -
            @endif
        </td>
