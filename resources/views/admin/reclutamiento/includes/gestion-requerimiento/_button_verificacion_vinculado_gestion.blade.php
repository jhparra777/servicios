...
<script>
    function deshabilitar_o_no(code){
       var code2=parseInt(code);
       
       if (code2 == 0){
         document.getElementById("pre_contratar").disabled = true;   
       } else {
         document.getElementById("pre_contratar").disabled = false; 
       }
    }
