                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <table class="table">
                                ...
                                <tr>
                                    <th class="width-perc">Empresa contrata</th>
                                    <td>
                                        @if($requermiento->empresa_contrata != null)
                                            {{ $requermiento->empresa_logo()->nombre_empresa }}
                                        @endif
                                    </td>
                                    <th class="width-perc">
                                        Centro de costos
                                    ...
                                    <td class="width-perc">
                                        @if($requermiento->centro_costo != null)
                                            {{ $requermiento->centro_costo }}
                                        @endif
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <th class="width-perc">Nivel 5</th>
                                    <td class="width-perc">
                                        @if($requermiento->nivel_5_id != null)
                                            {{ $requermiento->nivel5()->descripcion }}
                                        @endif
                                    </td>

                                    <th class="width-perc">Nivel 6</th>
                                    <td class="width-perc">
                                        @if($requermiento->nivel_6_id != null)
                                            {{ $requermiento->nivel6()->descripcion }}
                                        @endif
                                    </td>
                                </tr>

                                <tr>
                                    <th class="width-perc">Nivel 7</th>
                                    <td class="width-perc">
                                        @if($requermiento->nivel_7_id != null)
                                            {{ $requermiento->nivel7()->descripcion }}
                                        @endif
                                    </td>

                                    <th class="width-perc">Nivel 8</th>
                                    <td class="width-perc">
                                        @if($requermiento->nivel_8_id != null)
                                            {{ $requermiento->nivel8()->descripcion }}
                                        @endif
                                    </td>
                                </tr>
                                ...
                                @if(!empty($requermiento->documento))
                                    <th class="width-perc"> Documento adjunto </th>
                                    <td class="width-perc">
                                        <a href="{{ route('home') }}/documentos_solicitud/{{$requermiento->documento}}" target="_blank"> Ver documentos</a>
                                    </td>
                                @endif
                            </table>
                        </div>
