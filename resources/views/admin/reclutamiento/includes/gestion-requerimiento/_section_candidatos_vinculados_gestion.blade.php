                            ...
                            >
                                ...
                                <td>
                                    {{-- @if($candidato_req->estado_candidatos != "TRANSFERIDO") --}}
                                       ...
                                       <button 
                                            type="button" 
                                            class="btn btn-sm construir_email | tri-br-2 tri-fs-12 tri-txt-purple tri-bg-white tri-bd-purple tri-transition-300 tri-hover-out-purple" 
                                            title="Enviar Correo" 
                                            data-numero_id="{{$candidato_req->numero_id}}">                                        
                                            <i class="fa fa-envelope fa-lg"></i>
                                        </button>
                                                    {!! Form::hidden("numero_id", $candidato_req->numero_id) !!}
                                        @endif
