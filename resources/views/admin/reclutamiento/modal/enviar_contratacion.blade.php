...
<div class="modal-body">
    @if(count($candidato) > 0)
        ...
        @if( isset($sitio) && $sitio->asistente_contratacion == 1 )
            ...
            <div class="col-md-12 form-group">
                ...
                <div class="col-sm-8">
                    <select name="tipo_ingreso" id="tipo_ingreso" class="form-control">
                        @foreach ($tipos_ingreso as $id => $ing)
                            <option value="{{ $id }}" @if($dato_contrato) @if($dato_contrato->tipo_ingreso == $id) selected @endif @endif>{{ $ing }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="col-md-12 form-group">
                <label for="nivel_5" class="col-sm-4 control-label">Nivel 5 *</label>

                <div class="col-sm-8">
                        {!! Form::select("nivel_5_id", $nivel_5, $requerimiento->nivel_5_id,
                        [
                            "class" => "form-control",
                            "required" => "required",
                            "id" => "nivel_5"
            ...
            <div class="col-md-12 form-group">
                <label for="nivel_6" class="col-sm-4 control-label">Nivel 6 *</label>

                <div class="col-sm-8">
                        {!! Form::select("nivel_6_id", $nivel_6, $requerimiento->nivel_6_id,
                        [
                            "class" => "form-control",
                            "required" => "required",
                            "id" => "nivel_6"
            ...
            <div class="col-md-12 form-group">
                <label for="nivel_5" class="col-sm-4 control-label">Nivel 7 *</label>

                <div class="col-sm-8">
                        {!! Form::select("nivel_7_id", $nivel_7, $requerimiento->nivel_7_id,
                        [
                            "class" => "form-control",
                            "required" => "required",
                            "id" => "nivel_7"
            ...
            <div class="col-md-12 form-group">
                <label for="nivel_8" class="col-sm-4 control-label">Nivel 8 *</label>

                <div class="col-sm-8">
                        {!! Form::select("nivel_8_id", $nivel_8, $requerimiento->nivel_8_id,
                        [
                            "class" => "form-control",
                            "required" => "required",
                            "id" => "nivel_8"
            ...
            <div class="col-md-12 form-group">
                <label for="tipo_empleado" class="col-sm-4 control-label">Tipo empleado</label>

                <div class="col-sm-8">
                        {!! Form::select("tipo_empleado_id", $tipos_empleados, $requerimiento->tipo_empleado_id,
                        [
                            "class" => "form-control",
                            "id" => "tipo_empleado_id"
                            ]);
            ...
            <div class="col-md-12 form-group">
                ...
                <div class="col-sm-8">
                    {!! Form::text("arl", 'SURA', ["class" => "form-control", "id" => "arl", "readonly" => "readonly"]); !!}
                </div>
            ...
            <!-- formas de pago -->
            <div class="col-md-12 form-group">
                <label for="forma_pago" class="col-sm-4 control-label">Forma de pago:</label>
                
                <div class="col-sm-8">
                    {!! Form::select("forma_pago", $formas_pago, null, ["class" => "form-control selectcategory", "id" => "forma_pago"]) !!}
                </div>
            ...
            <div class="col-md-12 form-group">
                <label for="arl" class="col-sm-4 control-label">Código nómina del cliente:</label>
                
                <div class="col-sm-8">
                    {!! Form::select("nomina_cliente_id", $nominas_clientes, $candidato->nomina_cliente_id, [
                            "class" => "form-control selectcategory",
            ...
            <div class="col-md-12 form-group">
                <label for="arl" class="col-sm-4 control-label">Objeto contrato:</label>
                
                <div class="col-sm-8">
                    {!! Form::select("objeto_contrato_id", $objetos_contrato, $candidato->objeto_contrato_id, [
                            "class" => "form-control selectcategory",
            ...
            <div class="col-md-12 form-group">
                <label for="arl" class="col-sm-4 control-label">Subtipo cotizante:</label>
                
                <div class="col-sm-8">
                    {!! Form::select("subtipo_cotizante_id", $subtipo_cotizante, $candidato->subtipo_cotizante_id, [
                            "class" => "form-control selectcategory",
