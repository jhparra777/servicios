...
<div class="row">
    ...
    <div class="row">
        <div class="col-md-6 form-group">
            <label class="col-sm-2 control-label" for="descripcion">Tamaño de la empresa:</label>
            <div class="col-sm-10">
                {!! Form::select("tamanio_cliente_id", $tamanio_empresa, null, ["class" => "form-control"]); !!}
            </div>
            <p class="error text-danger direction-botones-center" style="{{ ($errors->has('tamanio_cliente_id') ? '' : 'display: none;') }}">
                {!! FuncionesGlobales::getErrorData("tamanio_cliente_id", $errors) !!}
            </p>
        </div>

        <div class="col-md-6  form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Logo cliente</label>
            <div class="col-sm-10">
