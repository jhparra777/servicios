...
<head>
    ...
    <style>
        ...
        .divider-hd{ width: 100%; background-color: #25943b; color: #25943b; border: 0; height: 1px; margin-top: -15px; }
        ...
        .divider-25{ width: 25%; background-color: #25943b; color: #25943b; border: 0; height: 1px;  }
    ...
    <main class="main">
        ...
        @if($datos_basicos->descrip_profesional != '')
            <section class="secciones-titulos-2">
                ...
                <hr align="left" class="divider-hd">
            </section>
            <section>
        ...
        @if($experiencias->count() >= 1)
            <section class="secciones-titulos-2">
                <h2 class="titulo">EXPERIENCIAS</h2>
                <hr align="left" class="divider-hd">
            </section>
        ...
        @if($familiares->count() >= 1)
            <section class="secciones-titulos-2">
                <h2 class="titulo">GRUPO FAMILIAR</h2>
                <hr align="left" class="divider-hd">
            </section>
        ...
        @if($reqcandidato != null)
            ...
            <section class="secciones-titulos-2 text-center">
                <h2 style="color: #25943b; width: 95%;" class="text-uppercase">
        ...
        @if($entrevistas->count() >= 1)
            @foreach($entrevistas as $key => $entrevista)
                <section class="secciones-titulos-2">
                    <h2 class="titulo" class="text-uppercase">ENTREVISTA {{ \App\Models\DatosBasicos::convertirFecha($entrevista->created_at) }}</h2>
                    <hr align="left" class="divider-hd">
                </section>
        ...
        @if($entrevistas_virtuales->count() >= 1)
            <section class="secciones-titulos-2">
                <h2 class="titulo">ENTREVISTA VIRTUAL ARCHIVO</h2>
                <hr align="left" class="divider-hd">
            </section>
        ...
        @if(count($entrevista_multiple) > 0)
            <section class="secciones-titulos-2">
                <h2 class="titulo" class="text-uppercase">ENTREVISTA MÚLTIPLE {{ \App\Models\DatosBasicos::convertirFecha($entrevista_multiple->created_at) }}</h2>
                <hr align="left" class="divider-hd">
            </section>
        ...
        @if($pruebas_idiomas->count() >= 1)
            <section class="secciones-titulos-2">
                <h2 class="titulo">PRUEBA IDIOMA ARCHIVO</h2>
                <hr align="left" class="divider-hd">
            </section>
        ...
        @if(isset($preliminar))
            @if($preliminar->count() >= 1)
                <section class="secciones-titulos-2">
                    <h2 class="titulo">INFORME PRELIMINAR</h2>
                    <hr align="left" class="divider-hd">
                </section>
        ...
        @if ($resp_ethical_values != null || $resp_personal_skills != null || $resp_bryg != null)
            <section class="secciones-titulos-2">
                <h2 class="titulo">PRUEBAS PSICOTÉCNICAS</h2>
                <hr align="left" class="divider-hd">
            </section>
        ...
        @if($pruebas->count() >= 1)
            <section class="secciones-titulos-2">
                <h2 class="titulo">EVALUACIÓN PSICOMÉTRICA</h2>
                <hr align="left" class="divider-hd">
            </section>
        ...
        @if ($resp_user_excel_basico != null || $resp_user_excel_intermedio != null || $resp_digitacion != null)
            <section class="secciones-titulos-2">
                <h2 class="titulo">PRUEBAS TÉCNICAS</h2>
                <hr align="left" class="divider-hd">
            </section>
        ...
        @if($examenes_medicos->count() >= 1)
            <section class="secciones-titulos-2">
                <h2 class="titulo">EXÁMENES MÉDICOS</h2>
                <hr align="left" class="divider-hd">
            </section>
            <section>
        ...
        @if($estudio_seguridad->count() >= 1)
            <section class="secciones-titulos-2">
                <h2 class="titulo">ESTUDIO SEGURIDAD</h2>
                <hr align="left" class="divider-hd">
            </section>
            <section>
        ...
        @if($sitioModulo->consulta_tusdatos == 'enabled')
            @if(!empty($tusdatosData))
                <section class="secciones-titulos-2">
                    <h2 class="titulo">CONSULTA DE SEGURIDAD</h2>
                    <hr align="left" class="divider-hd">
                </section>
                <section>
        ...
        @if ($sitioModulo->listas_vinculantes == 'enabled' && $listas_vinculantes_proceso)
            @if (!empty($consulta_lista_vinculante))
                @if($consulta_lista_vinculante->count() >= 1)
                    <section class="secciones-titulos-2">
                        <h2 class="titulo">LISTAS VINCULANTES</h2>
                        <hr align="left" class="divider-hd">
                    </section>
        ...
        @if ($experiencias_verificadas->count() >= 1)
            <section class="secciones-titulos-2">
                <h2 class="titulo">REFERENCIACIÓN</h2>
                <hr align="left" class="divider-hd">
            </section>
            <section>
        ...
        @if ($referencias_estudios_verificados->count() >= 1)
            <section class="secciones-titulos-2">
                <h2 class="titulo">REFERENCIACIÓN ACADÉMICA</h2>
                <hr align="left" class="divider-hd">
            </section>
            <section>
        ...
        @if (count($validacion_documental) >= 1)
            <section class="secciones-titulos-2">
                <h2 class="titulo">VALIDACIÓN DOCUMENTAL</h2>
                <hr align="left" class="divider-hd">
            </section>
            <section>
                <div class="m-auto" style="width: 95%;">
