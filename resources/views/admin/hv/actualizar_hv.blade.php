                ...
                @if(route("home") == "http://komatsu.t3rsc.co" || route("home") == "https://komatsu.t3rsc.co")
                 ...
                 <div class="col-sm-6 col-lg-6">
                    ...
                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("segundo_nombre",$errors) !!}</p>
                        ...
                        <div class="col-sm-6 col-lg-6">
                            <div class="form-group">
                                <label for="zapatos" class="col-md-5 control-label">Talla Zapatos:<span class='text-danger sm-text-label'>*</span></label>
                                <div class="col-md-7">
                        ...
                        <div class="col-sm-6 col-lg-6">  
                            <div class="form-group">
                                <label class="col-md-5 control-label">Talla Camisa<span class='text-danger sm-text-label'>*</span></label>
                                <div class="col-md-7">
                        ...
                        <div class="col-sm-6 col-lg-6">
                            <div class="form-group">
                                <label class="col-md-5 control-label">Talla Pantalon<span class='text-danger sm-text-label'>*</span></label>
               ...
               @if(route('home') != "https://gpc.t3rsc.co")
                ...
                <div class="col-sm-6 col-lg-6">
                 ...
                 <div class="col-md-7">
                   ...
                   {!! Form::select("nivel_cargo",["" => "Seleccionar"]+$niveles_cargo,null,["class"=>"form-control", "id"=>"nivel_cargo"]) !!}
