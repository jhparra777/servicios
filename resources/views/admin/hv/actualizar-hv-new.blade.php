                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            @else
                                ...
                                <div id="mujer_cabeza_familia" class="col-md-6" style="display:none;">
                                    <div class="form-group">
                                        <label> ¿Es mujer cabeza de familia? <span></span>
                                        </label>

                                        {!! Form::select("cabeza_familia_id", $cabeza_familia,null,["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300","id"=>"cabeza_familia"]) !!}
                                ...
                                @if(route('home') != "https://gpc.t3rsc.co")
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="talla_zapatos">Talla zapatos: <span class='text-danger sm-text-label'>*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="talla_camisa">Talla camisa: <span class='text-danger sm-text-label'>*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="talla_pantalon">Talla pantalón: <span class='text-danger sm-text-label'>*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="peso_id">Peso <span class='text-danger sm-text-label'>*</span></label>

                                            {!! Form::select("peso_id", $pesos, null, [
                                                "class" => "form-control selectcategory | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300",
                                                "id" => "peso_id",
                                                "required" => "required"
                                            ]) !!}

                                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("peso_id", $errors) !!}</p>
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="estatura_id">Estatura <span class='text-danger sm-text-label'>*</span></label>

                                            {!! Form::select("estatura_id", $estaturas, null, [
                                                "class" => "form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300",
                                                "id" => "estatura_id",
                                                "required" => "required"
                                            ]) !!}

                                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("estatura_id", $errors) !!}</p>
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="tipo_vivienda_id">Tipo de vivienda:</label>

                                        {!! Form::select("tipo_vivienda_id", $tipos_vivienda, null, [
                                            "class" => "form-control selectcategory | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300",
                                            "id" => "tipo_vivienda_id"
                                        ]) !!}
                                    </div>

                                    <p class="error text-danger direction-botones-center">{!!FuncionesGlobales::getErrorData("tipo_vivienda_id", $errors)!!} </p>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="estrato">Estrato: <span class='text-danger sm-text-label'>*</span></label>

                                        {!! Form::select("estrato", $estrato, null, [
                                            "class" => "form-control selectcategory | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300",
                                            "id" => "estrato",
                                            "required" => "required"
                                        ]) !!}
                                ...
                                <div class="col-md-6" id="grupo_poblacional">
                                    <div class="form-group">
                                        ...
                                        {!!Form::select("grupo_poblacional", $grupos_poblacionales, $datos_basicos->grupo_poblacional, [
                                            "class" => "form-control selectcategory | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300",
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                            <label for="tipo_vehiculo">Profesión:</label>

                                            {!!Form::select("profesion_sorttime_id", $profesiones_sorttime, null, [
                                                "id" => "profesion_sorttime_id",
                                                "class" => "form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300"
                                            ]) !!}
                                    </div>

                                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("profesion_sorttime_id", $errors) !!}</p>
