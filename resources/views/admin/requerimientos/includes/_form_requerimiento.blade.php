        ...
        <div class="panel-body">
            ...
            <div class="col-md-6 form-group">
                ...
                <select name="auxilio_transporte" class="form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300" required> 
                    ...
                    <option value="No se Paga" @if($requermiento->auxilio_transporte == 'No se Paga') selected @endif> No se paga </option>
                    <option value="Total" @if($requermiento->auxilio_transporte == 'Total') selected @endif> Total </option>
                    <option value="Mitad" @if($requermiento->auxilio_transporte == 'Mitad') selected @endif> Mitad </option>
                </select>
            </div>
