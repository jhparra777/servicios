<script>
        ...
        $(function () {
            ...
            //funcion q recibe como parametro la cant de dias habiles a contar (cant_dias)
            //devuelve la cant de dias a sumar a la fecha actual para cumplir con la cantidad de dias habiles
            function sumar_dias_habiles(cant_dias) {
                var from = moment(),
                //var from = moment("2022-07-01");
                dias_habiles = 0;
                dias_no_habiles = 0;
                while (dias_habiles <= cant_dias) {
                    ...
                    from.add(1, 'd');
                    days = dias_habiles + dias_no_habiles;
                }
                days = days -1;
                return days;
            }
            ...
            function setMinDate() {
                var tipo_proceso_id = $('#tipo_proceso_id').val();

                if(tipo_proceso_id == "2"){
                    var string = moment().add(7, 'd');
                    return new Date(string);
                    // var days = sumar_dias_habiles(2);
                    // var string = moment().add(days, 'd');
                    // return new Date(string);
                }
                else{
                    var string = moment();
            ...
            $('#tipo_proceso_id').on("change", function (e) {
                $('#fecha_ingreso').datepicker('option', {
                    minDate: setMinDate()
                });
            });
