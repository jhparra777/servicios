...
<div class="row">
    <div class="col-md-6 form-group">
        <label for="inputEmail3" class="col-sm-4 control-label">Nivel 5</label>
        <div class="col-sm-8">
          {{$requerimiento->nivel5()->descripcion}}
        </div>
    </div>
    <div class="col-md-6 form-group">
        <label for="inputEmail3" class="col-sm-4 control-label">Nivel 6</label>
        <div class="col-sm-8">
          {{$requerimiento->nivel6()->descripcion}}
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6 form-group">
        <label for="inputEmail3" class="col-sm-4 control-label">Nivel 7</label>
        <div class="col-sm-8">
          {{$requerimiento->nivel7()->descripcion}}
        </div>
    </div>
    <div class="col-md-6 form-group">
        <label for="inputEmail3" class="col-sm-4 control-label">Nivel 8</label>
        <div class="col-sm-8">
          {{$requerimiento->nivel8()->descripcion}}
        </div>
    </div>
</div>
