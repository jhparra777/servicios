...
@section("contenedor")
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="col-md-6 form-group">
                            <label class="control-label" for="descripcion">Código CNO:</label>
                            {!! Form::select("codigo_cno_id", $codigos_cno, null, ["class" => "form-control"]); !!}

                            <p class="error text-danger direction-botones-center" style="{{ ($errors->has('codigo_cno') ? '' : 'display: none;') }}">
                                {!! FuncionesGlobales::getErrorData("codigo_cno", $errors) !!}
                            </p>
                        </div>

                        <div class="col-md-6 form-group">
                            <label class="control-label" for="descripcion">Código CIIU:</label>
                            {!! Form::select("codigo_ciiu_id", $codigos_ciiu, null, ["class" => "form-control"]); !!}

                            <p class="error text-danger direction-botones-center" style="{{ ($errors->has('codigo_ciiu_id') ? '' : 'display: none;') }}">
                                {!! FuncionesGlobales::getErrorData("codigo_ciiu_id", $errors) !!}
                            </p>
                        </div>

                        <div class="col-md-6 form-group">
                            <label class="control-label" for="descripcion">Código Homologación *</label>
                            {!! Form::text("homologa_id", null, ["class" => "form-control", "placeholder" => "Código Homologación", "required" => "required", "id"=> "homologa_id"]); !!}

                            <p class="error text-danger direction-botones-center" style="{{ ($errors->has('homologa_id') ? '' : 'display: none;') }}">
                                {!! FuncionesGlobales::getErrorData("homologa_id", $errors) !!}
                            </p>
                        </div>
        ...
        $(function(){
            ...
            $('.btn-guardar-cargo').click(function() {
                ...
                if($('#fr_cargos_especificos').smkValidate()) {
                    ...
                    if($("#homologa_id").val() == "CPT"){
                        $.smkAlert({
                            text: 'Campo cod. Homologación es requerido',
                            type: 'danger',
                            time: 5
                        });
                        return false;
    ...
    <script>
        ...
        const input = document.getElementById('homologa_id');

        // Prefix formatter
        addFormatter(input, createRegexFormatter(/^CPT/, 'CPT'));
    </script>
@stop
