...
<div class="modal-body">
    {!! Form::model($registro, ["id" => "fr_cargos_especificos", "route" => "admin.cargos_especificos.actualizar", "method" => "POST", "files" => true]) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-12 form-group">
                <label class="col-sm-2 control-label" for="descripcion">Código CNO:</label>
                <div class="col-sm-10">
            ...
            <div class="col-md-12 form-group">
                <label class="col-sm-2 control-label" for="descripcion">Código CIIU:</label>
                <div class="col-sm-10">
            ...
            <div class="col-md-12 form-group">
                <label class="col-sm-2 control-label" for="homologa_id">Código Homologación: *</label>
                <div class="col-sm-10">
                    {!! Form::text("homologa_id", null, ["class" => "form-control", "placeholder" => "Código Homologación", "required" => "required"]); !!}
                </div>
