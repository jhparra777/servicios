...
<div class="col-md-12">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-6">
                <div class="form-group @error('tipo_proceso_id') has-feedback has-error smk-select @enderror">
                    ...
                    {!! Form::select("tipo_proceso_id",$tipoProceso, old('tipo_proceso_id'), ["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300", "id" => "tipo_proceso_id", "required" => "required"]); !!}
            ...
            <div class="col-md-6">
                <div class="form-group @error('ciudad_id') has-feedback has-error smk-select @enderror">
                    ...
                    {!! Form::text("sitio_trabajo", null, ["placeholder" => "Seleccionar una opción de la lista desplegable", "class" => "form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300", "id" => "sitio_trabajo_autocomplete", "required" => "required"]); !!}
            ...
            <div class="col-md-6">
                <div class="form-group @error('asignado_a') has-feedback has-error smk-select @enderror">
                    <label for="inputEmail3" class="control-label">Asignado a: <span class='text-danger sm-text-label'>*</span></label>
            ...
            <div class="col-md-6">
                <div class="form-group @error('nivel_5_id') has-feedback has-error smk-select @enderror">
                    <label for="nivel_5" class="control-label">Nivel 5: <span class='text-danger sm-text-label'>*</span></label>

                    {!! Form::select("nivel_5_id", $nivel_5, null,
                        [
            ...
            <div class="col-md-6">
                <div class="form-group @error('nivel_6_id') has-feedback has-error smk-select @enderror">
                    <label for="nivel_6" class="control-label">Nivel 6: <span class='text-danger sm-text-label'>*</span></label>

                    {!! Form::select("nivel_6_id", $nivel_6, null,
                        [
                            "class" => "form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300",
                            "required" => "required",
                            "id" => "nivel_6"
            ...
            <div class="col-md-6">
                <div class="form-group @error('nivel_7_id') has-feedback has-error smk-select @enderror">
                    <label for="nivel_7" class="control-label">Nivel 7: <span class='text-danger sm-text-label'>*</span></label>

                    {!! Form::select("nivel_7_id", $nivel_7, null,
                        [
                            "class" => "form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300",
                            "required" => "required",
                            "id" => "nivel_7"
            ...
            <div class="col-md-6">
                <div class="form-group @error('nivel_8_id') has-feedback has-error smk-select @enderror">
                    <label for="nivel_8" class="control-label">Nivel 8: <span class='text-danger sm-text-label'>*</span></label>

                    {!! Form::select("nivel_8_id", $nivel_8, null,
                        [
                            "class" => "form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300",
                            "required" => "required",
                            "id" => "nivel_8"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="inputEmail3" class="control-label">Tipo empleado:</label>

                    {!! Form::select("tipo_empleado_id",$tipos_empleados, null, ["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300", "id" => "tipo_empleado_id"]); !!}
                </div>
            </div>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="col-md-6">
                <div class="form-group @error('centro_costo_id') has-feedback has-error smk-select @enderror">
                    <label for="inputEmail3" class="control-label">Centro de Costos: <span class='text-danger sm-text-label'>*</span></label>
                                    
                    {!! Form::select("centro_costo_id",$centro_costo,null,["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300","id"=>"centro_costo_id", "required" => "required"]); !!}
        ...
        <div class="panel-body">
            ...
            <div class="col-md-6">
                <div class="form-group @error('tipo_liquidacion') has-feedback has-error smk-select @enderror">
                    ...
                    {!! Form::select("tipo_liquidacion",$tipo_liquidacion,$tipo_liquidacion_id,["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300","id"=>"tipo_liquidacion","required"]); !!}
            ...
            <div class="col-md-6 form-group">
                <label for="auxilio_transporte" class="col-sm-12 control-label">Auxilio de Transporte <span class='text-danger sm-text-label'>*</span></label>             
                <select name="auxilio_transporte" class="form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300" required>
