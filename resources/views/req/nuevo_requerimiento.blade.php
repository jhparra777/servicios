                    ...
                    <div class="box box-info">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::select("empresa_contrata",$empresa_logo,null,["class"=>"form-control", "id" => "empresa_contrata", "required" => "required"]); !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                <label for="inputEmail3" class="col-sm-4 control-label">Asignado a: <span class="">*</span></label>

                                <div class="col-sm-8">
                                    {!! Form::select("asignado_a",$psicologos, null, ["class"=>"form-control", "id" => "asignado_a", "required" => "required"]); !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                <label for="nivel_7" class="col-sm-4 control-label">Nivel 7 *</label>
                            ...
                            <div class="col-md-6 form-group">
                                <label for="inputEmail3" class="col-sm-4 control-label">Tipo empleado</label>

                                <div class="col-sm-8">
                                    {!! Form::select("tipo_empleado_id",$tipos_empleados, null, ["class"=>"form-control", "id" => "tipo_empleado_id"]); !!}
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 form-group">
                          <div class="col-md-12">
                           <label>Ciudad Trabajo *</label> <br>
                            ...
                            <div class="col-md-3 form-group">
                                <div class="col-sm-12">
                                    <label>Asignado a: <span>*</span></label>
                                    {!! Form::select("asignado_a_multi[]",$psicologos, null, ["class"=>"form-control", "id" => "asignado_a_multi"]); !!}
                                </div>
                            </div>
            ...
            $(document).on('click', '#enviar_requerimiento_btn', function() {
              ...
              //  }
                ...
                if($('#tipo_proceso_id').val() == ''){
                    ...
                    $('#empresa_contrata').css('border', 'solid 1px red');
                    $('#empresa_contrata').focus();

                    setTimeout(function(){
                        $('#empresa_contrata').css('border', 'solid 1px #d2d6de');
                    }, 4000);
                  ...
                  setTimeout(function(){
                    ...
                    $('#nivel_5').css('border', 'solid 1px red');
                    $('#nivel_5').focus();

                    setTimeout(function(){
                        $('#nivel_5').css('border', 'solid 1px #d2d6de');
                    }, 4000);
                }
                else if($('#nivel_6').val() == ''){
                    $('#nivel_6').css('border', 'solid 1px red');
                    $('#nivel_6').focus();

                    setTimeout(function(){
                        $('#nivel_6').css('border', 'solid 1px #d2d6de');
                    }, 4000);
                }
                else if($('#nivel_7').val() == ''){
                    $('#nivel_7').css('border', 'solid 1px red');
                    $('#nivel_7').focus();

                    setTimeout(function(){
                        $('#nivel_7').css('border', 'solid 1px #d2d6de');
                    }, 4000);
                }
                else if($('#nivel_8').val() == ''){
                    $('#nivel_8').css('border', 'solid 1px red');
                    $('#nivel_8').focus();

                    setTimeout(function(){
                        $('#nivel_8').css('border', 'solid 1px #d2d6de');
                    }, 4000);
                }
